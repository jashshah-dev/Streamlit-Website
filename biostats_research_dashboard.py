...
def biostats_research_dashboard():
    ...
    # Question: How does the relationship between Age and Duration of Stay look like?
    st.header("How does the relationship between Age and Duration of Stay look like?")
    ...
    # Question: How does the relationship between Age and Duration of Intensive Unit Stay look like?
    st.header("How does the relationship between Age and Duration of Intensive Unit Stay look like?")
    ...
    # Question: How does the relationship between Age, Platelet count, and Diabetes Mellitus look like?
    st.header("How does the relationship between Age, Platelet count, and Diabetes Mellitus look like?")
    ...
    # Question: How does the interaction effect between HTN, CKD, and Duration of Stay look like?
    st.header("How does the interaction effect between HTN, CKD, and Duration of Stay look like?")
    ...
    # Question: How does the relationship between Hemoglobin, Duration of Intensive Unit Stay, and Heart Failure look like?
    st.header("How does the relationship between Hemoglobin, Duration of Intensive Unit Stay, and Heart Failure look like?")
